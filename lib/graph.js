...
imglink = "http://register.ffm.freifunk.net/stats-rewrites/nodes/" + Number.parseInt(d.id.replace(/:/g, ""), 16) + "/stats/ping.png?secs=3600&width=400&height=160&no_summary=2"
    nodeinfo.append("a")
            .attr("target","_blank")
            .attr("href",imglink)
            .append("img")
  ...
  nodeinfo.append("p")
          .append("label")
.append("a").attr("href", "http://sstats.ffm.freifunk.net/png/host.php?h=freifunk-" + d.id.replace(/:/g, "")).text("Alle Statistiken")
